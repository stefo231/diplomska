...
export default class Item2 extends React.Component {
  ...
  render() {
    const { text, name, imageWidth, imageHeight, uid, image, coordinates } = this.props;
...
//Showing Metadata from user's name and description
